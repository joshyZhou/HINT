...
parser.add_argument(
    '--opt', type=str, default='./Options/HINT_LOL_v2_synthetic.yml', help='Path to option YAML file.')
parser.add_argument('--weights', default='./models/lolv2Syn.pth',
                    type=str, help='Path to weights')
parser.add_argument('--dataset', default='LOL_v2_synthetic', type=str,
                    help='Test Dataset') 
