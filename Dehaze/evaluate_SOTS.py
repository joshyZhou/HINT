...
def proc(filename):
    ...
    tar_name = './dataset/haze/promptIR/outdoor/gt/' + prd_name
...
parser = argparse.ArgumentParser(description='Dehazing using HINT')
...
for dataset in datasets:
    ...
    gt_path = os.path.join('./dataset/haze/promptIR/outdoor/gt')
