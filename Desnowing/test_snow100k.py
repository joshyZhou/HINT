...
parser.add_argument('--input_dir', default='./dataset/Snow100K/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/HINT', type=str, help='Directory for results')
parser.add_argument('--weights', default='./models/snow100k.pth', type=str, help='Path to weights')
